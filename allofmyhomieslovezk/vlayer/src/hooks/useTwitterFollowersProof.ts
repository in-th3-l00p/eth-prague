  ...
  useEffect(() => {
    if (result) {
      ...
      setProverResult(JSON.stringify({
        followers: Number.parseInt(((result as any[])[1] as bigint).toString())
      }));
    }
  }, [result]);
